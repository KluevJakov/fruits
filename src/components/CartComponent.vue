        ...
        <div class="cart__items-container">
          <div class="cart__item" v-for="item in cartItems" :key="item?.id">
            ...
            <div class="cart__item-quantity-container">
              ...
              <v-btn icon="mdi-plus" class="rounded-btn" @click="quantityIncrement(item)">
              </v-btn>
            </div>
        ...
        <div class="cart__form">
          <form @submit.prevent="sendForm(cartFormInfo)">
            <div class="cart__form-input-container">
              ...
              <input
                v-model="cartFormInfo.customerName"
                type="text"
            ...
            <div class="cart__form-input-container">
              ...
              <input
                v-model="cartFormInfo.phoneCustomer"
                type="tel"
                class="cart__form-input"
                placeholder="+7"
                required
            ...
            <div class="cart__form-input-container">
              ...
              <input
                v-model="cartFormInfo.phoneReceiver"
                type="tel"
                class="cart__form-input"
                placeholder="+7"
                required
            ...
            <div class="cart__form-input-container">
              ...
              <input
                v-model="cartFormInfo.deliveryDate"
                type="date"
                class="cart__form-input"
                placeholder="+7"
                required
            ...
            <div class="cart__form-input-container">
              <p class="cart__form-input-title">
            ...
            <button
              ...
              class="cart__form-submit"
              type="submit"
            >
              Перейти к оплате
            </button>
            <router-link to="/auth">
              <button v-if="!isAuth" @click="store.setCartValue(false)" class="cart__form-submit" type="button">
